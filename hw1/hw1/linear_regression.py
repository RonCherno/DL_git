...
def top_correlated_features(df: DataFrame, target_feature, n=5):
    ...
    # ====== YOUR CODE: ======
    feature_corr = df.corr()[target_feature].sort_values(ascending=False)
    abs_feature_corr = feature_corr.abs()
    #abs_feature_corr.sort_values(ascending=False)

    top_n_features = abs_feature_corr.index[:n]
    top_n_corr = abs_feature_corr[top_n_features]
    # ========================
