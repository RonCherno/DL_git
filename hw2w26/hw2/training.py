    ...
    def fit(
        ...
        **kw,
        ...
        for epoch in range(num_epochs):
            ...
            train_loss.append(train_results.losses)
            train_acc.append(train_results.accuracy)
            test_loss.append(test_results.losses)
            ...
            if best_acc is None or test_results.accuracy > best_acc:
                # ====== YOUR CODE: ======
                best_acc = train_results.accuracy
                epochs_without_improvement = 0
                if checkpoints is not None:
                    # Save a checkpoint since test accuracy improved
                ...
                if early_stopping is not None and epochs_without_improvement >= early_stopping:
                    self._print(f"*** Early stopping: Test accuracy did not improve for {early_stopping} epochs.")
